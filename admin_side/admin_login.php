...
if($is_form_valid){
    ...
    if(!$conn){
        ...
        try{
        $sql = "SELECT admin_user_id,admin_user_type from admin_users where admin_user_email = '$email' and admin_user_password = '$password'";
...
<body>
    ...
    <main>
        ...
        <div class="container custom_container">
            <div class="row">
                <div class=" col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 custom_col py-4 custom_form">
                    <form class="pt-3 px-3 pb-2" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        <div class="h2 text-center fw-bold">Admin Login</div>
                        <div class="ps-4 pt-2">
                            ...
                            value="<?php if(!empty($retain_email)){
                                echo $retain_email;
                            }else{
                                echo "";
                            } ?>">
                        ...
                        <div class="ps-4 pt-2">
                            ...
                            <input type="password" name="pwd" id="pwd" class="form-control custom_form_field_width ps-3" placeholder="Enter Password"
                            value="<?php if(!empty($retain_password)){
