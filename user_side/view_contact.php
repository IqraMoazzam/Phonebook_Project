...
<body>
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="breakpoints col-lg-2 col-md-3 col-sm-4 d-flex gap-4 flex-column bg-dark pt-3 ps-3 sticky-sidebar">
                ...
                <div class="breakpoints_temp col-lg-10 col-md-9 col-sm-8">
                    <div class="container">
                        <div class="row">
